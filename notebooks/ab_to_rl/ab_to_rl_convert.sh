...
uv run ../notebook_convert.py \
    ...
    --image "/images/social/2026-05-14-beta-distribution-probabilities-preview.png" \
...
uv run ../notebook_convert.py \
    ...
    --image "/images/social/2026-05-17-beta-prior-sequential-binary-decisions-preview.png" \

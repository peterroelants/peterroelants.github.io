...
uv run ../notebook_convert.py \
    ...
    --image "/images/social/2018-09-26-multi-armed-bandit-implementation-preview.png" \
    --tags "Multi-Armed Bandit (MAB)" "Thompson Sampling" "A/B-testing" "Beta Distribution" "Notebook" \
...
uv run ../notebook_convert.py \
    ...
    --image "/images/social/2018-09-28-multivariate-normal-primer-preview.png" \
...
uv run ../notebook_convert.py \
    ...
    --image "/images/social/2018-10-22-linear-regression-four-ways-preview.png" \

...
The kernel-fitting post uses Bokeh 3.9.1. Its conversion command rewrites the
Bokeh CDN loader to the version-pinned bundles under
`../../js/bokeh/3.9.1/` and lazy-loads its three tagged charts near the viewport.

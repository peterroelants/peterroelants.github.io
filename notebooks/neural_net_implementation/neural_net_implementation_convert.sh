...
uv run ../notebook_convert.py \
    ...
    --image "/images/social/2015-06-12-neural-network-implementation-part01-preview.png" \
...
uv run ../notebook_convert.py \
    ...
    --image "/images/social/2015-06-13-neural-network-implementation-part02-preview.png" \
...
uv run ../notebook_convert.py \
    ...
    --image "/images/social/2015-06-14-neural-network-implementation-part03-preview.png" \
...
uv run ../notebook_convert.py \
    ...
    --image "/images/social/2015-06-15-neural-network-implementation-part04-preview.png" \
...
uv run ../notebook_convert.py \
    ...
    --image "/images/social/2015-06-16-neural-network-implementation-part05-preview.png" \

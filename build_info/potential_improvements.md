...
Responsibility: this document is a backlog-style scratchpad for possible site
improvements. Keep exploratory ideas, rationale, and acceptance checks here;
move implemented architecture details to `build_info/site_overview.md` and
standard command references to `build_info/jekyll.md`.
